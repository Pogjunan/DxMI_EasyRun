...
if __name__ == "__main__":
    ...
    checkpoint = torch.load(sampler_path, map_location=device, weights_only=False)
    ...
    if args.guidance_scale is not None:
        ...
        checkpoint = torch.load(value_path, map_location=device, weights_only=False)
    ...
    if local_rank <= 0:
        ...
        if args.stat is None:
            ...
            d_fid_stats = torch.load(args.stat, weights_only=False)
